...
const emailVideo = async (req, res) => {
  ...
  const mailOptions = {
    ...
    <div style="text-align: center; display: flex; align-items:center; justify-content: center; margin-bottom: 20px;">
        <img src="https://res.cloudinary.com/dikeogwu1/image/upload/v1701431905/HelpMeOut%20Chrome%20Extension/main-icon-xl_ac3gka.png" alt="ScreenTalkMaster Brand Logo" style="max-width: 25px;">
        <h2 style="margin-left: 20px;">ScreenTalkMaster</h2>
    </div>
    <h2>Hello dear,</h2>
